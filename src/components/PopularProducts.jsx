...
const PopularProducts = () => {
  ...
  return (
    <section className="py-4 lg:py-15">
      <Container>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 -mr-px -mb-px px-4 md:px-6 lg:px-0">
          {products.map((item) => (
            <div
              ...
              className="group relative border border-brdrtwo -mr-px -mb-px bg-white transition-all duration-300 hover:border-[#2C742F] hover:shadow-[0_0_12px_0_rgba(32,181,38,0.32)] hover:z-10 cursor-pointer overflow-hidden py-3 lg:py-0"
            >
              ...
              <div className="absolute top-2 right-2 lg:top-4 lg:right-4 flex flex-col gap-2 lg:gap-3 opacity-0 group-hover:opacity-100 transition duration-300 z-10">
                <button
                  onClick={(e) =>
              ...
              <img
                ...
                className="h-36 sm:h-44 lg:h-57.5 mx-auto object-contain px-2 pt-2 lg:px-1.25 lg:pt-1.25"
              />
              ...
              <button
                ...
                className="absolute bottom-3 right-2.5 lg:bottom-6 lg:right-4 w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-[#f2f2f2] text-logoc cursor-pointer flex items-center justify-center transition-all duration-300 group-hover:bg-green-500 group-hover:text-white z-10 disabled:opacity-60 text-sm lg:text-base shadow-sm"
              >
