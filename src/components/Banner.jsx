                        ...
                        <div className='w-218 relative'>
                            ...
                            <div className="bg-[linear-gradient(77deg,rgba(0,0,0,0.6)_0%,rgba(0,0,0,0)_100%)] w-full h-full absolute top-0 left-0 rounded-[10px]">
                                <div className="max-w-146 absolute top-1/2 -translate-y-1/2 left-15">
                                    <h1 className='font-pop font-semibold text-5xl text-white leading-[120%]'>Fresh & Healthy Organic Food</h1>
                                    <div className='py-7 pl-3.5 relative after:w-0.5 after:h-16.25 after:bg-[#84D187] after:content-[] after:absolute after:top-8  after:left-0'>
                                        <div className="flex gap-x-2 items-center">
                                            <h3 className='font-pop font-medium text-[20px] text-white leading-[150%]'>Sale up to </h3>
                                            <span className='bg-[#FF8A00] py-1 px-3 font-pop font-semibold text-[20px] text-white leading-[150%] rounded-[5px]'>30% OFF</span>
                                        </div>
                                        <p className='defaultfs text-white/80 pt-2'>Free shipping on all your order.</p>
                                    </div>
                    ...
                    <SwiperSlide>
                        <div className='bg-[#DAE5DA] w-218 h-150 rounded-[10px] relative'>
                            <div className="absolute top-1/2 -translate-y-1/2 left-15 flex items-center">
                                <div>
                                    <h1 className='font-pop font-semibold text-hsize text-logoc leading-[120%]'>Fresh & Healthy Organic Vegetable</h1>
                                    <div className='py-7 pl-3.5 relative after:w-0.5 after:h-16.25 after:bg-[#84D187] after:content-[] after:absolute after:top-8  after:left-0'>
                                        <div className="flex gap-x-2 items-center">
                                            <h3 className='font-pop font-medium text-[20px] text-logoc leading-[150%]'>Sale up to </h3>
                                            <span className='bg-[#FF8A00] py-1 px-3 font-pop font-semibold text-[20px] text-white leading-[150%] rounded-[5px]'>50% OFF</span>
                                        </div>
                                        <p className='defaultfs text-gry pt-2'>Free shipping on all your order.</p>
                                    </div>
                                    <div className="inline-flex items-center gap-x-4 bg-primary py-4 px-10 rounded-[53px] cursor-pointer">
                                        <button className='font-pop font-semibold text-base text-white leading-[120%] cursor-pointer'>Shop now</button>
                        ...
                        <div className='bg-[#FFF4E6] w-218 h-150 rounded-[10px] relative'>
                            <div className="flex flex-col justify-center text-center">
                                <div className='pt-10 max-w-120 mx-auto'>
                                    <h1 className='font-pop font-semibold text-[40px] text-primary leading-[120%]'>Fresh & Healthy Organic Fruits</h1>
                                    <p className='defaultfs text-gry pt-2 pb-5'>Free shipping on all your order.</p>
                                </div>
                                <div className='relative'>
                                    ...
                                    <div className='bg-[#FF8A00] w-15 h-15 rounded-full absolute top-5 right-75 flex items-center justify-center'>
                                        <div className="flex flex-col">
                                            <span className='font-pop font-semibold text-[20px] text-white leading-[100%]'>30%</span>
                                            <span className='font-pop font-normal text-sm text-white leading-[100%]'>OFF</span>
                                        </div>
                                    </div>
                                </div>
