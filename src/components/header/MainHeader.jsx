                    ...
                    <div className="flex lg:hidden items-center justify-end w-1/2 shrink-0 order-2 gap-1 sm:gap-2">
                        <Link to="/wishlist" className="relative p-1.5 text-logoc hover:text-primary transition cursor-pointer mt-0.5">
                            ...
                            {totalWishlistItems > 0 && (
                                <span className="absolute top-0 -right-0.75 flex items-center justify-center min-w-4 h-4 bg-[#2C742F] text-white text-[9px] font-bold rounded-full px-1 border border-white shadow-sm">
                                    {totalWishlistItems}
                                </span>
                            )}
                        </Link>
