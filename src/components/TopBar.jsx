...
const TopBar = () => {
  return (
    <div className='border-b border-solid border-gry'>
     <Container>
        <div className='flex justify-between font-pop font-normal text-sm text-gry leading-[130%] py-3'>
            ...
            <div className='flex gap-x-10'>
                ...
                <div className='relative after:w-px after:h-3.75 after:bg-[#E6E6E6] after:content-[] after:absolute after:top-0.5 after:-left-5'>
                    Sign In / Sign Up
                </div>
            </div>
        </div>
