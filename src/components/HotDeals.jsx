...
const HotDeals = () => {
  ...
  const loadProducts = async () => {
    ...
    // ডায়নামিক রেটিং রেন্ডার করার ফাংশন
                            ...
                            >
                                ...
                                <div className="mt-auto">
                                    ...
                                    <div className="flex justify-between items-end">
                                        ...
                                        {/* Small Cart Button */}
                                        <button className="absolute bottom-6 right-4 w-10 h-10 rounded-full bg-[#f2f2f2] text-logoc flex items-center justify-center transition-all duration-300 group-hover:bg-primary group-hover:text-white hover:bg-primary hover:text-white cursor-pointer z-20">
