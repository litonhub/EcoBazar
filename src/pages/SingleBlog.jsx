...
const SingleBlog = () => {
  ...
  if (!blog) {
    return (
      <div className="py-20 text-center text-gray-500 min-h-[50vh] flex flex-col items-center justify-center">
        ...
        <button onClick={() => navigate("/blog")} className="bg-[#00B207] text-white px-6 py-2 rounded-full">Back to Blog</button>
      </div>
    );
  }
  ...
  return (
    <>
      <PageBanner items={["Blog", "Single_Blog"]} />
      ...
      <Container className="py-12 font-pop text-logoc">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 w-full overflow-hidden">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-gray-100 mb-8">
              ...
              <div className="flex items-center gap-2">
                <button className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white hover:bg-[#00B207] transition bg-gray-50"><FaFacebookF size={14} /></button>
                <button className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white hover:bg-[#00B207] transition bg-gray-50"><FaTwitter size={14} /></button>
                <button className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white hover:bg-[#00B207] transition bg-gray-50"><FaPinterestP size={14} /></button>
                <button className="w-10 h-10 rounded-full flex items-center justify-center text-gray-600 hover:text-white hover:bg-[#00B207] transition bg-gray-50"><FiLink size={14} /></button>
              </div>
            </div>
            ...
            <div className="relative w-full h-48 sm:h-56 bg-[#0a1a0f] rounded-lg overflow-hidden flex items-center p-6 md:p-10 mb-12 shadow-lg">
              <div className="relative z-10 text-white max-w-sm">
                <span className="text-xs font-medium uppercase tracking-wider text-gray-300 block mb-1">Summer Sales</span>
                <h3 className="text-3xl font-semibold mb-4">Fresh Fruit</h3>
            ...
            <div className="mb-12">
              <h2 className="text-xl font-semibold text-logoc mb-6">Leave a Comment</h2>
              <form onSubmit={handleCommentSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="flex flex-col">
                    <label className="text-sm text-gray-600 mb-1.5">Full Name</label>
                    <input 
                      type="text" 
                  ...
                  <div className="flex flex-col">
                    <label className="text-sm text-gray-600 mb-1.5">Email</label>
                    <input 
                      type="email" 
                ...
                >
                  {commentMutation.isPending ? "Posting..." : "Post Comments"}
                </button>
              </form>
            </div>
            ...
            {comments.length > 0 && (
              <div>
                <h2 className="text-xl font-semibold text-logoc mb-6">Comments</h2>
          ...
          <div className="w-full lg:w-[310px] shrink-0 space-y-8 mt-12 lg:mt-0">
              ...
              <ul className="space-y-3">
                {categories.map((cat, idx) => {
                  ...
                  return (
                    <li 
                      key={idx}
                      onClick={() => navigate(`/blog?category=${encodeURIComponent(catId)}`)}
              ...
              <div className="flex flex-wrap gap-2">
                {popularTags.map((tag, idx) => {
                  ...
                  return (
                    <button
                      key={idx}
                      onClick={() => navigate(`/blog?tag=${encodeURIComponent(tagValue)}`)}
